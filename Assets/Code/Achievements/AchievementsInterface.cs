...
public class AchievementsInterface : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        GameObject a_panel = InterfaceTool.Img_Setup("Panel", achievement_interface.transform, out Image panel_img, SysManager.defaultBox, false);
        ...
        GameObject a_header = InterfaceTool.Img_Setup("Header", a_panel.transform, out Image header_img, SysManager.defaultBox, false);
        ...
        InterfaceTool.Format_Text(a_header_txt, SysManager.defaultFont, 48, Color.white, TextAnchor.MiddleCenter, FontStyle.Normal);
        ...
        GameObject back_button_obj = InterfaceTool.Button_Setup("Back Button", a_panel.transform, out Image back_img, out Button back_button, SysManager.defaultButton,
        ...
        InterfaceTool.Format_Text(back_button_txt, SysManager.defaultFont, 36, Color.black, TextAnchor.MiddleCenter, FontStyle.Normal);
    ...
    void CreateAchievementBlocks()
    {
        ...
        for (int i = 0; i < a_blocks.Length; i++)
        {
            ...
            a_blocks[i].block_obj = InterfaceTool.Img_Setup($"Achievement #{i}", a_list, out a_blocks[i].block, SysManager.defaultBox, false);
            ...
            InterfaceTool.Format_Text(a_blocks[i].title, SysManager.defaultFont, 32, Color.white, TextAnchor.UpperLeft, FontStyle.Bold);
            ...
            InterfaceTool.Format_Text(desc, SysManager.defaultFont, 24, Color.white, TextAnchor.UpperLeft, FontStyle.Normal);
            ...
            InterfaceTool.Format_Text(a_blocks[i].value, SysManager.defaultFont, 32, Color.white, TextAnchor.UpperRight, FontStyle.Italic);
            ...
            InterfaceTool.Format_Text(a_blocks[i].date, SysManager.defaultFont, 28, Color.white, TextAnchor.UpperRight, FontStyle.Normal);
            ...
            InterfaceTool.Format_Text(a_blocks[i].progress_txt, SysManager.defaultFont, 32, Color.black, TextAnchor.MiddleCenter, FontStyle.Normal);

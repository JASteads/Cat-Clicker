...
public class AchievementSystem
{
    ...
    {
        data = new List<AchievementData>
        {
            new AchievementData("First Click!",
            "Start your journey with your first click ever!",
            AchievementType.CP, 1,
            1,
            () => { return GameManagement.profile.clscSaveData.TotalClicks; },
            () => { return GameManagement.profile.clscSaveData.TotalClicks > 0; },
            null),
            ...
            1,
            () => { return GameManagement.profile.clscSaveData.BitsPerSecond; },
            () => { return GameManagement.profile.clscSaveData.BitsPerSecond >= 1; },
            null),
            ...
            100,
            () => { return GameManagement.profile.clscSaveData.CurrencyTotal; },
            () => { return GameManagement.profile.clscSaveData.CurrencyTotal >= 100; },
            null),
            ...
            1,
            () => { return GameManagement.profile.clscSaveData.misc.FeverUpTime; },
            () => { return GameManagement.profile.clscSaveData.misc.FeverUpTime > 0; },
            null),
            ...
            100,
            () => { return GameManagement.profile.clscSaveData.TotalClicks; },
            () => { return GameManagement.profile.clscSaveData.TotalClicks > 99; },
            null),
